...
Uses SQLite database and includes store app.
"""

import os
from pathlib import Path

# Build paths - project root directory
...
INSTALLED_APPS = [
    ...
    'store',  # Our e-commerce store app
]
...
# Login redirect - where to send users after login
